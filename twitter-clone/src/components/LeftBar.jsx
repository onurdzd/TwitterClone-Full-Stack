    ...
    <>
      <section className="w-[30%] flex flex-col items-center gap-2 min-h-[100%] text-xl justify-between">
        <nav className="flex flex-col gap-5 h-[70%] cursor-pointer ">
          ...
          <div className="max-w-fit hover:bg-slate-100 rounded-full flex items-center p-2 font-bold">
          ...
          <div className="max-w-fit hover:bg-slate-100 rounded-full flex items-center p-2">
            <svg width="40" height="25">
          ...
          <button className="bg-[#1d9bf0] rounded-full p-3 sm:min-w-[233px] text-white font-bold mt-4">
            Gönder
          </button>
        </nav>

                ...
                <div className="flex flex-col pl-2">
                  <div className="flex items-center">
                    <div className="font-bold flex text-base items-center">
                      Onur Dizdar
                      <span className="max-[600px]:scale-75 scale-90 hover:bg-slate-200 rounded-full p-1 cursor-pointer px-1">
                    ...
                    <div className="font-light text-sm max-[600px]:text-xs text-slate-500">@o_diz</div>
                  </div>
                  ...
                  <div className="flex justify-between py-2 ">
                    <div className="flex max-[600px]:gap-0 lg:gap-2 gap-1 sm:items-end max-[600px]:items-center">
                      ...
                      <div className="text-sm max-[600px]:text-xs text-slate-500">17</div>
                    </div>
                    ...
                    <div className="flex  max-[600px]:gap-0 lg:gap-2 gap-1 sm:items-end max-[600px]:items-center">
                      ...
                      <div className="text-sm max-[600px]:text-xs text-slate-500">45,3 B</div>
                    </div>

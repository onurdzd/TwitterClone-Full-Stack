                ...
                <div className="flex flex-col pl-2">
                  <div className="flex items-center">
                    <div className="font-bold flex text-base items-center">
                      Onur Dizdar
                      <span className="scale-90 hover:bg-slate-200 rounded-full p-1 cursor-pointer px-1">
                    ...
                    <div className="font-light text-sm text-slate-500">@o_diz</div>
                  </div>
                  ...
                  <div className="flex justify-between py-2 ">
                    <div className="flex gap-2 items-end">
                      <div className="scale-90 hover:bg-slate-200 rounded-full p-1 cursor-pointer">
                    ...
                    <div className="flex gap-2 items-end hover:text-blue-300">
                      <div className="scale-90 hover:bg-slate-200 rounded-full p-1 cursor-pointer">
                        <svg width="22" height="21.7" fill="grey">
                    ...
                    <div className="flex gap-2 items-end">
                      ...
                      <div className="text-sm text-slate-500">45,3 B</div>
                    </div>
